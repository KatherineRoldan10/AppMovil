...
const Chat =() => {
    ...
    const apiKey = "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"
    ...
    const handleSend = async () => {
        ...
        const tokensConsumidos = response.data.usage.total_tokens;
            ...
            {type: "bot", "text":'Este texto tiene ' + text + ' vocales.' + ' (' + tokensConsumidos + ' TOKENS CONSUMIDOS'}]);
            setTextInput("");
            }
                ...
                renderItem={( {item}) => (
                  <View style={{flexDirection:"row", padding: 10}}>
                      <Text style={{fontWeight: "bold", color: item.type === "user" ? "green" : "red"}}>
                         {item.type === "user" ? "Convertidor Hexadeximal" : "Bot"}
                       </Text>
                     ...
                     <TextInput
                       ...
                       placeholder = "Convertidor binario"
                       />
